#!/bin/bash
#
# Use this script to START an JDBC IRIS Query Worker service
#
...
printf "${PURPLE}\n"
echo '********************************************************************************'
echo 'Starting Query Worker as a service'
echo '********************************************************************************'
printf "${NOCOLOR}\n"

../../image-query-worker/projects/iris-jdbc-query-worker.jar start --server.port=$WORKER_PORT
